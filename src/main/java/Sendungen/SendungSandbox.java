...
public class SendungSandbox{
		...
		public static String ermittleStadt(String e)
		{
		...
		public static void write() throws IOException, JAXBException
		{
			...
			{	        	
				...
				marshaller.marshal(aviso, 
						new File("C:\\Users\\WACKED01\\Documents\\Sendungsdateien\\SendungenMitDiensten/SendungAmbient" 
				+ i + ".xml"));
				...
				else
				{
					...
					marshaller.marshal(aviso, 
							new File("C:\\Users\\WACKED01\\Documents\\Sendungsdateien\\SendungenMitDiensten/Sendung"
									+ i + ".xml"));
				}	
